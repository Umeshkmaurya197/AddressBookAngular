...
export class FormComponent implements OnInit {
  ...
  onSubmit() {
    this.contactService.addContact(this.contact).subscribe((Response: any) => {
  ...
  getContactById() {
    this.contactService.getContactById(this.Id).subscribe((response: any) => {
      ...
      console.log("i print this line",this.contact);

    });
  }

  updateContactByIdOnly() {
    this.contactService
      .updateContactById(this.Id, this.contact)
  ...
  States: State[] = [
    ...
    { value: 'Arunachal Pradesh', viewValue: 'chennai' },
